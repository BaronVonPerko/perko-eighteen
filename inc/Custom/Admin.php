...
use Perko\Api\Settings;
use Perko\Api\Callbacks\SettingsCallback;
...
class Admin
{
	...
	private function enqueue()
	{
		...
		$pages = array( 'toplevel_page_Perko' );
	...
	private function enqueue_faq( Settings $settings )
	{
		...
		// Pages array to where enqueue scripts
		$pages = array( 'Perko_page_Perko_faq' );
	...
	private function pages()
	{
		$admin_pages = array(
			array(
				...
				'icon_url' => get_template_directory_uri() . '/assets/dist/images/Perko-logo.png',
				'position' => 110,
			)
		);
	...
	private function settings()
	{
		...
		$args = array(
			array(
				'option_group' => 'Perko_options_group',
				'option_name' => 'first_name',
				'callback' => array( $this->callback, 'Perko_options_group' )
			),
			array(
				'option_group' => 'Perko_options_group',
				'option_name' => 'Perko_test2'
			)
		);
	...
	private function sections()
	{
		...
		$args = array(
			array(
				'id' => 'Perko_admin_index',
				'title' => 'Settings',
				'callback' => array( $this->callback, 'Perko_admin_index' ),
				'page' => 'Perko'
			)
		);
