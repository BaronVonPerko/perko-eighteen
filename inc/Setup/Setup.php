...
class Setup
{
    ...
    public function setup()
    {
        ...
        //load_theme_textdomain( 'Perko', get_template_directory() . '/languages' );
        ...
        add_theme_support( 'custom-background', apply_filters( 'Perko_custom_background_args', array(
