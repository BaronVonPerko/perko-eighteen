...
class Gutenberg
{
	...
	public function gutenberg_enqueue()
	{
		...
		register_block_type( 'gutenberg-test/latest-post', array(
			'render_callback' => array( $this, 'Perko_render_block_latest_post' ),
			'editor_style' => 'gutenberg-test',
			'style' => 'gutenberg-test'
		) );
	}

	public function Perko_render_block_latest_post( $attributes )
	{
		...
		return sprintf(
			'<a class="wp-block-Perko-latest-post" href="%1$s">%2$s</a>',
