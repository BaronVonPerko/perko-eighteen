...
class Customizer 
{
	...
	public function output()
	{
		echo '<!--Customizer CSS--> <style type="text/css">';
			echo self::css( '#sidebar', 'background-color', 'Perko_sidebar_background_color' );
			echo self::css( '.site-footer', 'background-color', 'Perko_footer_background_color' );
			echo self::css( '.site-header', 'background-color', 'Perko_header_background_color' );
			echo self::css( '.site-header', 'color', 'Perko_header_text_color' );
			echo self::css( '.site-header a', 'color', 'Perko_header_link_color' );
